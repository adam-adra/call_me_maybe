...
from transformers import AutoModelForCausalLM, AutoTokenizer, PreTrainedTokenizer, PreTrainedModel, logging # type: ignore[import-not-found]
...
class Small_LLM_Model:
    ...
    def decode(self, ids: torch.Tensor | list[int]) -> str:
        ...
        if isinstance(ids, torch.Tensor):
            ids = ids.tolist()
        return self._tokenizer.decode(ids, skip_special_tokens=True) # type: ignore[no-any-return]
    ...
    def get_path_to_vocab_file(self) -> str:
        ...
        return vocab_path # type: ignore[no-any-return]
    ...
    def get_path_to_merges_file(self) -> str:
        ...
        return merges_path # type: ignore[no-any-return]
    ...
    def get_path_to_tokenizer_file(self) -> str:
        ...
        return tokenizer_path # type: ignore[no-any-return]
